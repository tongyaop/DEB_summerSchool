...
par.z = 0.8787*0.7;       free.z     = 1;   units.z = '-';            label.z = 'zoom factor'; 
...
par.E_Hb = 2.203e-06*0.8; free.E_Hb  = 1;   units.E_Hb = 'J';         label.E_Hb = 'maturity at birth'; 
par.E_Hj = 8.376e-06*0.3*0.8; free.E_Hj  = 1;   units.E_Hj = 'J';         label.E_Hj = 'maturity at metamorphosis'; 
par.E_Hp = 5.868e-01*0.8; free.E_Hp  = 1;   units.E_Hp = 'J';         label.E_Hp = 'maturity at puberty'; 
par.h_a = 1.937e-09;  free.h_a   = 1;   units.h_a = '1/d^2';      label.h_a = 'Weibull aging acceleration'; 
par.s_G = 0.0001;     free.s_G   = 0;   units.s_G = '-';          label.s_G = 'Gompertz stress coefficient'; 

%% other parameters 
% par.T_L = 273.15;     free.T_L   = 0;   units.T_L = 'K';          label.T_L = 'T_L'; 
% par.T_AL = 1e+04;     free.T_AL   = 0;   units.T_AL = 'K';          label.T_AL = 'T_AL'; 
% par.T_H = 302;        free.T_H   = 0;   units.T_H = 'K';          label.T_H = 'T_H'; 
% par.T_AH = 2e4;      free.T_AH   = 0;   units.T_AH = 'K';          label.T_AH = 'T_AH'; 
